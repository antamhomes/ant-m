const translations = {
  cs: {
    ...
    hero_desc: "Ceny, rezervace, hosty, úklid i provoz bereme na sebe. Vy vidíte výsledek.",
    ...
    about_p2: "Úspěšný byt dnes nestačí jen vystavit na Airbnb nebo Booking. Rozhoduje správné nastavení ceny, prezentace, fotografie, hodnocení, rychlost komunikace, práce s obsazeností i desítky malých rozhodnutí během celého roku.",
    about_p3: "Trh se mění a my s ním. Sledujeme výsledky každý den a průběžně upravujeme, jak je každý byt nabízen a řízen.",
    ...
    report_desc: "Skutečný byt z portfolia, průměr z dvanácti měsíčních vyúčtování. Peníze posíláme do 15. dne následujícího měsíce.",
    ...
    faq17_q: "Proč 30 %?",
    faq17_a: "Protože to děláme dobře. Byty v naší správě jedou nad obsazeností okolí, jak je vidět ve Výsledcích výš. Nižší provize za slabší správu znamená na konci roku míň peněz, ne víc. V odměně 30 % je i písemné roční minimum a krytí menších škod od hostů.",
    ...
    // Ceník
    pricing_label: "Ceník",
    pricing_title: "Vyděláváme, jen když vydělává byt.",
    pricing_desc: "Naše odměna je 30 % z čistého výnosu. Žádné fixní ani měsíční poplatky.",
    pr1_name: "Správa",
    ...
    contact_fallback_desc: "Pošlete adresu a dispozici. Do 24 hodin od nás máte propočet pro váš konkrétní byt a výši písemného minima. Zdarma a nezávazně.",
