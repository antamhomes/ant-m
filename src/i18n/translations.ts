const translations = {
  cs: {
    ...
    services_desc: "Interiér, který hosté hledají. Fotky, které prodávají. Cena, která sleduje poptávku. Servis, který přinese recenze. Každý článek děláme jako řemeslo. Protože nejlepší výsledky přicházejí, když všechno funguje dohromady.",
    ...
    about_stat1_label: "apartmánů ve správě",
    ...
    price_figure: "25 %",
    price_sub: "Čistý výnos jsou tržby za ubytování bez úklidového poplatku, po\u00a0odečtení provize Airbnb/Booking.com a zákonné DPH z této provize. Odměna je konečná, nic dalšího se\u00a0nepřičítá. Žádné fixní ani měsíční poplatky. Úklidový poplatek platí host, energie majitel.",
    price_garance: "Ke každému bytu, který vezmeme do správy, dáváme písemnou garanci ročního výnosu: nejméně nájem plus energie. Když ji byt neunese, řekneme vám to na rovinu.",
    ...
    pr1_note: "Konečná cena, nic dalšího se\u00a0nepřičítá. Žádné fixní ani měsíční poplatky. Pokrývá internet, hygienické potřeby pro hosty i čisticí prostředky.",
  ...
  vi: {
    ...
    services_desc: "Nội thất chỉn chu. Hình ảnh bắt mắt. Giá đặt theo mùa và địa điểm. Phục vụ chu đáo. Việc nào Antam cũng lo đến nơi đến\u00a0chốn. Vì kết quả tốt nhất chỉ đến khi mọi thứ ăn khớp với\u00a0nhau.",
    ...
    about_stat1_value: "~10",
    about_stat1_label: "căn hộ đang quản lý",
    about_stat2_value: "520+",
    ...
    price_figure: "25%",
    price_sub: "Doanh thu ròng là tiền lưu trú không gồm phí dọn dẹp, sau khi trừ hoa hồng Airbnb/Booking.com và\u00a0thuế VAT theo luật của khoản hoa hồng đó. 25% là con số\u00a0cuối cùng, không cộng thêm gì. Không có\u00a0phí cố định, không phí tháng. Phí dọn dẹp khách trả riêng và\u00a0thuộc về\u00a0Antam, điện nước chủ nhà lo.",
    price_garance: "Căn nào Antam nhận quản lý cũng có cam kết bằng văn bản: mỗi năm chủ nhà nhận ít nhất bằng tiền thuê dài hạn cộng tiền điện nước. Căn nào không đạt được mức đó, Antam nói thẳng từ\u00a0đầu.",
    ...
    pr1_note: "Con số cuối cùng, không cộng thêm gì. Không phí cố định, không phí tháng. Đã gồm internet, đồ dùng cho khách và hóa chất dọn dẹp.",
