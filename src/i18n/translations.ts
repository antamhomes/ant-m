const translations = {
  cs: {
    ...
    calc_season: "Sezóna",
    calc_season_year: "Celoroční průměr",
    calc_season_summer: "Letní špička",
    calc_season_winter: "Zimní mimosezóna",
    ...
    calc_operations: "Provoz (energie, internet)",
    calc_our_fee: "Naše provize",
    calc_cleaning_note: "Úklid hradí host — neodečítá se",
  ...
  vi: {
    ...
    calc_season: "Mùa",
    calc_season_year: "Trung bình cả năm",
    calc_season_summer: "Cao điểm hè",
    ...
    calc_operations: "Vận hành (điện, internet)",
    calc_our_fee: "Phí dịch vụ của chúng tôi",
    calc_cleaning_note: "Khách trả phí dọn — không trừ vào doanh thu",
