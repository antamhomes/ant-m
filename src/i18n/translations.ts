const translations = {
  cs: {
    ...
    faq17_q: "Proč 30 %?",
    faq17_a: "Byty v naší správě drží vyšší obsazenost než srovnatelné nabídky v okolí, jak je vidět ve Výsledcích výš. Nižší provize za slabší správu znamená na konci roku míň peněz, ne víc.",
    ...
    pricing_desc: "Za správu si bereme 30 % z čistého výnosu. Bez měsíčního paušálu. Uvedení bytu do provozu je jednorázově 25 000 Kč.",
    pr1_name: "Správa",
    pr1_price: "30 % z čistého výnosu",
    pr1_price_short: "z čistého výnosu",
  ...
  vi: {
    ...
    pr1_price_short: "trên doanh thu ròng",
