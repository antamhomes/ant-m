const translations = {
  cs: {
    ...
    pdm_kpi_revenue: "Tržby",
    pdm_kpi_revenue_sub: "od platforem",
    ...
    portal_note: "Ukázka s vymyšlenými byty a čísly: skutečné obrazovky nesou jména hostů a příjem konkrétního majitele. Blokované noci se nepronajímají a poměrně snižují garantovaný výnos: 2/365 za noc, v hlavní sezóně 3/365.",
  ...
  vi: {
    ...
    pdm_kpi_revenue: "Doanh thu",
    pdm_kpi_revenue_sub: "từ nền tảng",
    pdm_kpi_adr: "Giá mỗi đêm",
    pdm_kpi_adr_sub: "mỗi đêm bán được",
    pdm_kpi_blocked: "Đêm của nhà mình",
    pdm_kpi_blocked_sub: "đã chặn cho chủ nhà",
    ...
    portal_note: "Bản thử với căn hộ và con số ví dụ: màn hình thật có tên khách và thu nhập của chủ nhà cụ thể. Đêm đã chặn thì không cho thuê và làm giảm mức tối thiểu theo tỷ lệ: 2/365 mỗi đêm, mùa cao điểm 3/365.",
