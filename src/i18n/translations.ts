const translations = {
  ...
  vi: {
    ...
    faq14_a: "Hoàn toàn có thể, và nhiều chủ nhà vẫn tự làm. Nhưng cho thuê ngắn hạn là việc phải theo dõi mỗi ngày: trả lời khách nhanh, điều chỉnh giá theo nhu cầu, lo dọn dẹp, giặt là và cập nhật liên tục những thay đổi từ Airbnb, Booking – từ thuật toán, quy định đến các chiến lược mới.\nNếu chỉ thỉnh thoảng mới xử lý, căn hộ rất dễ tụt hiển thị, mất khách hoặc bán giá thấp hơn mức có thể. Antam làm những việc này mỗi ngày cho nhiều căn hộ cùng lúc.\nBạn không cần mất thời gian chạy theo căn hộ. Hãy để căn nhà tạo thêm thu nhập cho bạn, chứ không phải tạo thêm công việc.\n",
