const translations = {
  cs: {
    ...
    hero_desc: "Správa krátkodobých pronájmů v Praze. Víc výnosu, méně starostí.",
    hero_extra: "Bez závazku · výpověď 4 měsíce · ozveme se do 24 hodin",
  ...
  vi: {
    ...
    nav_freeConsultation: "Nói chuyện với Antam",
    ...
    hero_desc: "Antam quản lý cho thuê ngắn hạn tại Praha. Anh chị thu nhiều hơn, đỡ phải lo.",
    ...
    // Services
    services_label: "Antam Homes lo những gì",
    services_title: "Bây giờ không còn chuyện „đăng lên là có khách“.",
    services_desc: "Nội thất khách thích. Ảnh đẹp thì khách mới chọn. Giá đúng theo mùa. Phục vụ tốt thì mới được đánh giá cao. Việc nào Antam cũng làm như nghề của mình, và làm cùng lúc cho anh chị.",
    svc1_title: "Chuẩn bị nhà và nội thất",
    svc1_desc: "Antam tư vấn cách sắp xếp, trang bị và những chi tiết nhỏ quyết định đánh giá. Không bảo anh chị mua thừa.",
    svc2_title: "Ảnh và tin đăng",
    svc2_desc: "Ảnh chụp chuyên nghiệp, tin đăng nổi giữa hàng trăm căn khác. Khách quyết định theo ảnh.",
    svc3_title: "Đặt giá",
    svc3_desc: "Antam chỉnh giá mỗi ngày theo mùa, theo khách, theo nhà xung quanh. Không để một giá cả năm.",
    svc4_title: "Khách và liên lạc",
    svc4_desc: "Trả lời khách trong vài phút, hướng dẫn nhận phòng, hỗ trợ suốt thời gian khách ở. Có chuyện là xử lý ngay.",
    svc5_title: "Dọn dẹp, kiểm tra, sửa chữa",
    svc5_desc: "Khách đi là dọn và kiểm tra. Hỏng nhỏ Antam sửa ngay, việc lớn thì gọi thợ.",
    svc6_title: "Bảng kê hàng tháng",
    svc6_desc: "Khách đặt bao nhiêu, thu bao nhiêu, chi gì, làm gì trong nhà. Gọn trong một trang cho anh chị.",

    // WhyBetter
    whyBetter_label: "Ngắn hạn hay dài hạn",
    whyBetter_title1: "Nhà của anh chị xứng đáng được ",
    whyBetter_title2: "chăm tốt hơn",
    whyBetter_title3: ", và sinh lời tốt hơn.",
    whyBetter_desc: "Cho thuê dài hạn thì đơn giản. Còn cho thuê ngắn hạn, nếu có người làm bài bản, anh chị vừa nắm nhà chắc hơn, vừa thu về nhiều hơn.",
    comp1_title: "Tình trạng nhà",
    comp1_long: "Cả năm anh chị mới thấy nhà một lần, có khi còn không.",
    comp1_short: "Khách đi là Antam kiểm tra, hỏng nhỏ sửa ngay.",
    comp2_title: "Tiền thu về",
    comp2_long: "Tiền thuê cố định, mùa đông khách cũng chỉ vậy.",
    comp2_short: "Giá theo mùa, theo khách. Đông khách thì giá lên.",
    comp3_title: "Linh hoạt",
    comp3_long: "Ký một hợp đồng là kẹt mấy năm.",
    comp3_short: "Anh chị muốn về ở, chỉ cần báo trước.",
    ...
    process_title: "Bắt đầu hợp tác thế nào",
    process_desc: "Bốn bước, từ lúc anh chị liên hệ đến khi nhà có khách.",
    step1_title: "Gửi thông tin nhà",
    step1_desc: "Anh chị chỉ cần gửi địa chỉ, vài tấm ảnh hoặc link, thêm đôi dòng.",
    ...
    step4_desc: "Khách, dọn dẹp, giá, lịch: Antam lo hết cho anh chị.",
    process_cta: "Gửi thông tin nhà",

    // About — Ai đứng sau (REVIEW: thay bằng lời của Vương + ảnh)
    about_label: "Ai đứng sau",
    about_title: "Một nhóm nhỏ ở Praha, làm nhà cho tử tế.",
    about_p1: "Antam Homes do người Việt và người Séc ở Praha lập nên. Cho thuê ngắn hạn, Antam học từ chính nhà mình chứ không phải từ sách vở. Bắt đầu với nhà của gia đình và người quen, đến nay Antam lo khoảng mười căn ở Praha và quanh Praha.",
    about_p2: "Anh chị nói chuyện với Antam bằng tiếng Việt hay tiếng Séc đều được, qua điện thoại, Zalo hay WhatsApp. Nhà nào Antam cũng biết tận nơi, khách tự tay lo, và tháng nào anh chị cũng có bảng kê rõ từng đồng.",
    ...
    price_figure: "25%",
    price_sub: "Đã gồm VAT, Antam không thu thêm gì. Không phí cố định, không phí tháng. Phí dọn dẹp khách trả riêng, điện nước anh chị lo như trước.",

    // Assurance (contact)
    assure1: "Không ràng buộc",
    assure2: "Báo trước 4 tháng",
    assure3: "Về ở lúc nào cũng được",
    assure4: "Bảng kê mỗi tháng",

    // Calculator
    calc_label: "Tính thử thu nhập",
    calc_title1: "Nhà của anh chị ",
    calc_title2: "thu được bao nhiêu?",
    calc_desc: "Antam ước tính theo loại nhà, quận và lượng khách. Con số để anh chị tham khảo.",
    calc_location: "Quận",
    calc_size: "Loại nhà",
    ...
    calc_extra_wellness: "Sauna / wellness riêng",
    ...
    calc_excluded_note: "Phí 25% là mức cuối, đã gồm VAT, tính trên tiền phòng chưa gồm phí dọn dẹp. Phí dọn dẹp khách trả riêng và thuộc về Antam (dọn dẹp, giặt giũ). Điện nước anh chị lo.",

    // Owner report
    report_label: "Bảng kê cho chủ nhà",
    report_title: "Chủ nhà phải biết nhà mình đang thế nào.",
    report_desc: "Đặt phòng, tiền thu, chi phí và những gì Antam đã làm trong nhà. Mỗi tháng gọn một trang.",
    report_text: "Không bảng biểu rối rắm. Nhà thu bao nhiêu, chi gì, Antam đã làm gì, anh chị thấy hết.",
    ...
    faq1_a: "Không sao. Antam xem nhà trước rồi nói rõ với anh chị nên chuẩn bị gì.",
    faq3_q: "Muốn dùng nhà cho mình thì sao?",
    faq3_a: "Được chứ. Anh chị báo trước là Antam khóa lịch, cho gia đình hay người quen cũng vậy.",
    faq4_q: "Làm sao biết nhà thu được bao nhiêu?",
    faq4_a: "Mỗi tháng Antam gửi anh chị một bảng kê gọn một trang: bao nhiêu đêm có khách, tiền từ Airbnb, từ Booking, phí 25%, và Antam đã làm gì trong nhà. Kèm hóa đơn phí, nên số nào cũng có gốc.",
    faq5_q: "Phí bao nhiêu?",
    faq5_a: "25% tiền phòng, đã gồm VAT, Antam không thu thêm gì. Không phí cố định, không phí tháng. Trong đó có cả internet, đồ dùng cho khách, hóa chất dọn dẹp. Sửa nhỏ đến 5 000 Kč Antam làm luôn và trừ vào tiền phòng; việc lớn hơn thì báo anh chị trước, anh chị đồng ý mới làm.",
    faq6_q: "Ai trả tiền dọn dẹp, điện nước?",
    faq6_a: "Khách trả tiền phòng và trả thêm phí dọn dẹp. Phí dọn dẹp thuộc về Antam, dùng để dọn và giặt, nên không trừ vào tiền phòng của anh chị; trong bảng kê nó là một dòng riêng. Phần chia 75/25 chỉ tính trên tiền phòng. Điện, nước, gas anh chị lo như trước.",
    faq7_q: "Hợp tác bao lâu, muốn nghỉ thì sao?",
    faq7_a: "Hợp đồng không thời hạn, muốn nghỉ anh chị báo trước 4 tháng. Khách hay đặt trước rất lâu, nên đặt phòng nào đã nhận thì Antam vẫn làm cho hết.",
    faq9_q: "Con số trong máy tính là trước hay sau phí?",
    faq9_a: "Sau. Con số nào gọi là tiền về tay chủ nhà đều đã trừ 25%. Điện nước anh chị lo riêng.",
    faq10_q: "Cho thuê ngắn hạn phải lo giấy tờ gì?",
    faq10_a: "Cho thuê ngắn hạn là kinh doanh nên có quy định: sổ khách, khai báo khách nước ngoài với cảnh sát ngoại kiều, phí lưu trú nộp cho quận, và mới đây là đăng ký e-Turista. Giấy tờ về khách Antam lo. Thuế thu nhập thì anh chị hoặc kế toán khai, chứng từ Antam đưa đủ.",
    faq11_q: "Khách làm hỏng đồ thì sao?",
    faq11_a: "Khách đi là Antam kiểm tra ngay, nên không có chuyện tháng sau mới biết. Hỏng nhỏ sửa ngay (đến 5 000 Kč, trừ vào tiền phòng). Hỏng lớn thì chụp ảnh, lập biên bản, làm việc với khách và với Airbnb, Booking (Airbnb có bảo hiểm AirCover cho chủ nhà). Anh chị được báo ngay, có ảnh kèm theo.",
    faq12_q: "Hàng xóm và ban quản trị nhà (SVJ)?",
    faq12_a: "Yên ổn với hàng xóm thì mới cho thuê lâu dài được. Khách nhận nội quy trước khi đến, số người tối đa rõ ràng, không tiệc tùng, hàng xóm có số điện thoại của Antam để gọi. Nếu SVJ cấm rõ, Antam nói thẳng với anh chị trước khi ký.",
    faq13_q: "Khi nào không nên cho thuê ngắn hạn?",
    faq13_a: "Khi SVJ cấm hoặc hàng xóm không muốn. Khi anh chị cần tháng nào cũng đúng một số tiền, vì tiền theo mùa có lên có xuống. Khi anh chị muốn tự ở phần lớn thời gian. Và khi nhà xuống cấp mà anh chị không muốn bỏ thêm gì. Còn lại Antam đều xem được; xa trung tâm hay nhà cũ không phải vấn đề.",
    faq14_q: "Sao không tự làm qua Airbnb?",
    faq14_a: "Có người tự làm được. Nhưng đây là việc mỗi ngày: trả lời khách trong vài phút, chỉnh giá theo khách, lo dọn dẹp và chìa khóa, và nhất là theo kịp Airbnb, Booking đổi luật liên tục. Tuần làm một lần là nhà tụt hạng, bán rẻ. Antam làm hằng ngày cho nhiều nhà một lúc, khác nhau ở chỗ đó.",

    // Contact
    contact_label: "Liên hệ",
    contact_title: "Cùng bàn về căn nhà của anh chị.",
    contact_desc: "Anh chị gửi cho Antam vài thông tin về nhà. Antam xem vị trí, tình trạng rồi nói anh chị nghe hướng nào hợp.",
    contact_name: "Họ tên",
    ...
    contact_pref: "Anh chị muốn Antam liên hệ qua",
    ...
    contact_status: "Hiện nay nhà anh chị đang",
    ...
    contact_fallback_desc: "Anh chị viết vài dòng về nhà là đủ, còn lại nói qua điện thoại.",
    ...
    footer_link_cookies: "Cookies",
    footer_cta: "Nói chuyện với Antam",
    footer_rights: "© 2026 Donut Point, s.r.o. Mọi quyền được bảo lưu.",

    // Sticky mobile
    mobile_cta: "Nói chuyện với Antam",
    ...
    foryou1_desc: "Nợ tiền nhà, phá nhà, đuổi mãi không chịu đi. Khách ngắn hạn thì trả tiền trước, ở vài đêm rồi đi. Anh chị không phải đòi, không phải kiện.",
    foryou2_title: "Không có thời gian lo khách",
    foryou2_desc: "Khách hỏi han, nhận phòng, chìa khóa, nửa đêm có chuyện. Những việc đó anh chị cứ để Antam lo.",
    foryou3_title: "Không muốn chạy theo Airbnb",
    foryou3_desc: "Airbnb, Booking tháng nào cũng đổi luật, đổi giá. Antam theo sát mỗi ngày, anh chị không phải bận tâm.",
    foryou4_title: "Sợ khách làm hỏng nhà",
    foryou4_desc: "Khách đi là Antam vào dọn và kiểm tra ngay, có gì hỏng thì sửa luôn. Cho thuê dài hạn thì cả năm anh chị mới thấy nhà một lần.",
    foryou5_title: "Muốn giữ nhà cho gia đình",
    foryou5_desc: "Người nhà sang chơi, có khách quý, hay anh chị muốn về ở. Chỉ cần báo trước, Antam khóa lịch cho anh chị.",
    foryou6_title: "Ở xa hoặc hay đi vắng",
    foryou6_desc: "Anh chị về Việt Nam nửa năm cũng không sao. Nhà vẫn có khách đều, tháng nào anh chị cũng thấy rõ tiền về.",
  },
} as const;
