const translations = {
  ...
  vi: {
    ...
    hero_desc: "Quản lý cho thuê ngắn hạn tại Praha. Giá, đặt phòng, khách, dọn dẹp, vận hành: Antam lo hết, chủ nhà không phải thêm việc.",
    hero_extra: "Các căn Antam đang quản lý: chủ nhà nhận 57 000 và 64 000 Kč mỗi tháng · Praha 1 · trung bình 12 tháng",
    ...
    step3_desc: "Nhà sẵn sàng thì Antam bắt đầu nhận khách luôn. Nếu cần chỉnh nội thất, ảnh hay tin đăng, hai bên thống nhất trước rồi mới làm.",
    ...
    calc_disclaimer_short: "Đây chỉ là con số tham khảo, không phải báo giá hay cam kết. Cam kết thu nhập chỉ có khi được ghi vào hợp đồng cho từng căn.",
    ...
    portal_open_note: "Bản xem thử dùng căn hộ và số liệu ví dụ. Đăng nhập dành cho chủ nhà đang có căn Antam quản lý.",
