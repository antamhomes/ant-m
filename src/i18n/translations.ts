const translations = {
  cs: {
    ...
    portal_open: "Otevřít portál",
    portal_open_note: "Přihlášení je pro majitele bytů v naší správě.",
  ...
  vi: {
    ...
    portal_open: "Mở cổng chủ nhà",
    portal_open_note: "Đăng nhập dành cho chủ nhà đang có căn Antam quản lý.",
