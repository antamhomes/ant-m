const translations = {
  cs: {
    ...
    calc_size: "Dispozice",
    calc_size_hint: "Podle dispozice bereme velikost bytu na\u00a0trhu: 1+kk a\u00a02+kk jako jednu ložnici, 3+kk dvě, 4+kk tři a\u00a0víc. Plochu si upravte posuvníkem, řídí\u00a0nájem.",
  ...
  vi: {
    ...
    calc_size: "Loại nhà",
    calc_size_hint: "Loại nhà quyết định cỡ căn trên thị trường: 1+kk và 2+kk tính là một phòng ngủ, 3+kk hai, 4+kk ba trở lên. Diện tích anh chị kéo thanh bên dưới, phần đó chỉ ảnh hưởng tiền thuê\u00a0dài\u00a0hạn.",
    calc_area: "Diện tích",
