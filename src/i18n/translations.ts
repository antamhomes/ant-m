const translations = {
  ...
  vi: {
    ...
    faq14_a: "Hoàn toàn có thể, và nhiều chủ nhà vẫn tự làm. Nhưng cho thuê ngắn hạn cần được theo dõi mỗi ngày: trả lời khách, điều chỉnh giá, lo dọn dẹp, giặt là và cập nhật các thay đổi từ Airbnb, Booking.\nNếu không theo sát, căn hộ dễ tụt hiển thị, mất khách và bán giá thấp hơn mức có thể. Antam làm những việc này mỗi ngày cho nhiều căn hộ cùng lúc.\nBạn có thêm thời gian cho công việc, gia đình và những việc quan trọng hơn, còn căn nhà vẫn tạo thu nhập tốt hơn mặt bằng thị trường.\n",
