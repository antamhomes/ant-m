const translations = {
  cs: {
    ...
    pd_title: "Deník bytu",
    pd_flat: "2+kk",
    pd_period: "Ukázka · září 2026",
    pd_by_antam: "Hradí Antam",
    pd_free: "bez poplatku",
    pd1_name: "Kontrola bytu po odjezdu hostů",
    pd1_note: "Výjezd, kontrola stavu, doplnění zásob.",
    pd2_name: "Výměna žárovky v obývacím pokoji",
    pd2_note: "Drobná údržba, strženo z výnosu podle VOP.",
    pd5_name: "Poškrábaná deska stolu",
    pd5_note: "Škoda od hosta, nezískaná zpět přes platformu. Hradíme z ročního krytí.",
    pd3_name: "Zrušený pobyt, platba dorazila celá",
    pd3_note: "Host zrušil po nevratném termínu, peníze zůstaly vám.",
    pd4_name: "Výměna těsnění pod dřezem",
    pd4_note: "Instalatér, díl a práce. Strženo z výnosu.",
    pd_budget: "Letos čerpáno z ročního krytí škod pro 2+kk",
    pd_note: "Ukázka s vymyšlenými čísly: skutečné obrazovky nesou jména hostů a příjem konkrétního majitele. Mechanika je ale skutečná, u každé položky vidíte, kdo ji platí.",
  ...
  vi: {
    ...
    // Owner report
    pd_title: "Nhật ký căn hộ",
    pd_flat: "2+kk",
    pd_period: "Bản thử · tháng 9/2026",
    pd_by_antam: "Antam trả",
    pd_free: "miễn phí",
    pd1_name: "Kiểm tra căn hộ sau khi khách đi",
    pd1_note: "Antam qua tận nơi, kiểm tra và bổ sung đồ dùng.",
    pd2_name: "Thay bóng đèn phòng khách",
    pd2_note: "Bảo trì nhỏ, trừ vào doanh thu theo hợp đồng.",
    pd5_name: "Mặt bàn bị xước",
    pd5_note: "Khách làm hỏng, không đòi được qua nền tảng. Antam chịu, trừ vào hạn mức năm.",
    pd3_name: "Khách huỷ, tiền vẫn về đủ",
    pd3_note: "Huỷ sau hạn không hoàn, tiền là của chủ nhà.",
    pd4_name: "Thay gioăng dưới bồn rửa",
    pd4_note: "Thợ nước, vật tư và công. Trừ vào doanh thu.",
    pd_budget: "Năm nay đã dùng, trong hạn mức lo hỏng hóc cho căn 2+kk",
    pd_note: "Đây là bản thử, con số là ví dụ: màn hình thật có tên khách và thu nhập của chủ nhà cụ thể. Nhưng cách làm là thật, mỗi mục đều ghi rõ ai trả.",
