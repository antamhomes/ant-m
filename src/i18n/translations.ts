const translations = {
  ...
  vi: {
    ...
    nav_freeConsultation: "Bàn về căn hộ",
    ...
    services_desc: "Nội thất khách thích. Ảnh đẹp khách mới chọn. Giá đúng theo mùa. Phục vụ tốt mới được đánh giá cao. Việc nào chúng tôi cũng làm như nghề, và làm cùng lúc.",
    svc1_title: "Chuẩn bị nhà và nội thất",
    svc1_desc: "Tư vấn sắp xếp, trang bị, những chi tiết nhỏ quyết định đánh giá. Không bảo chủ nhà mua thừa.",
    svc2_title: "Ảnh và tin đăng",
    svc2_desc: "Ảnh chụp chuyên nghiệp, tin đăng nổi giữa hàng trăm căn. Khách quyết định theo ảnh.",
    svc3_title: "Đặt giá",
    svc3_desc: "Giá chỉnh hằng ngày theo mùa, theo khách, theo nhà xung quanh. Không để một giá cả năm.",
    svc4_title: "Khách và liên lạc",
    svc4_desc: "Trả lời trong vài phút, hướng dẫn nhận phòng, hỗ trợ suốt thời gian khách ở. Có chuyện là xử lý ngay.",
    svc5_title: "Dọn dẹp, kiểm tra, sửa chữa",
    svc5_desc: "Khách đi là dọn và kiểm tra. Hỏng nhỏ sửa ngay, việc lớn gọi thợ.",
    svc6_title: "Bảng kê hàng tháng",
    svc6_desc: "Khách đặt bao nhiêu, thu bao nhiêu, chi gì, làm gì trong nhà. Gọn một trang.",

    // WhyBetter
    whyBetter_label: "Ngắn hạn hay dài hạn",
    whyBetter_title1: "Nhà của quý vị xứng đáng được ",
    whyBetter_title2: "chăm tốt hơn",
    whyBetter_title3: ", và sinh lời tốt hơn.",
    whyBetter_desc: "Cho thuê dài hạn thì đơn giản. Cho thuê ngắn hạn, làm cho bài bản, chủ nhà nắm nhà chắc hơn mà tiền về cũng nhiều hơn.",
    comp1_title: "Tình trạng nhà",
    comp1_long: "Cả năm mới thấy nhà một lần, có khi còn không.",
    comp1_short: "Khách đi là kiểm tra, hỏng nhỏ sửa ngay.",
    comp2_title: "Tiền thu về",
    comp2_long: "Tiền thuê cố định, mùa đông khách cũng vậy.",
    comp2_short: "Giá theo mùa. Đông khách, giá lên.",
    comp3_title: "Linh hoạt",
    comp3_long: "Ký một hợp đồng là kẹt mấy năm.",
    comp3_short: "Muốn ở, báo trước là được.",
    comp4_title: "Tiền bạc rõ ràng",
    comp4_long: "Chậm tiền, chủ nhà phải đi đòi.",
    comp4_short: "Khách trả qua Airbnb, Booking. Tháng nào cũng có bảng kê.",
    ...
    step1_desc: "Chỉ cần địa chỉ, vài tấm ảnh hoặc link, thêm đôi dòng.",
    step2_title: "Chúng tôi xem và đánh giá",
    step2_desc: "Xem vị trí, tình trạng nhà và các căn xung quanh.",
    step3_title: "Đề xuất cách làm",
    step3_desc: "Nói rõ nên chuẩn bị gì, sửa gì, sắp xếp gì.",
    step4_title: "Bắt đầu đón khách",
    step4_desc: "Khách, dọn dẹp, giá, lịch: chúng tôi lo hết.",
    ...
    about_p1: "Antam Homes do người Việt và người Séc ở Praha lập nên. Cho thuê ngắn hạn, chúng tôi học từ chính nhà mình chứ không phải từ sách vở. Bắt đầu với nhà của gia đình và người quen, đến nay lo khoảng mười căn ở Praha và quanh Praha.",
    about_p2: "Chủ nhà nói chuyện với chúng tôi bằng tiếng Việt hay tiếng Séc đều được, qua điện thoại, Zalo hay WhatsApp. Nhà nào chúng tôi cũng biết tận nơi, khách tự tay lo, tháng nào cũng có bảng kê rõ từng đồng.",
    about_p3: "Chúng tôi muốn chủ nhà chỉ phải nghĩ đến nhà khi muốn về nghỉ cuối tuần.",

    // Price strip
    price_label: "Phí dịch vụ",
    price_line: "tiền phòng",
    price_figure: "25%",
    price_sub: "Đã gồm VAT, không thu thêm gì. Không phí cố định, không phí tháng. Phí dọn dẹp khách trả riêng, điện nước chủ nhà lo.",

    // Assurance (contact)
    assure1: "Không ràng buộc",
    assure2: "Báo trước 4 tháng",
    assure3: "Dùng nhà bất cứ lúc nào",
    assure4: "Bảng kê mỗi tháng",

    // Calculator
    calc_label: "Tính thử thu nhập",
    calc_title1: "Nhà của quý vị ",
    calc_title2: "thu được bao nhiêu?",
    calc_desc: "Ước tính theo loại nhà, quận và lượng khách. Để tham khảo thôi.",
    calc_location: "Quận",
    calc_size: "Loại nhà",
    ...
    calc_excluded_note: "Phí 25% là mức cuối, đã gồm VAT, tính trên tiền phòng không gồm phí dọn dẹp. Phí dọn dẹp khách trả riêng và là của chúng tôi (dọn dẹp, giặt giũ). Điện nước chủ nhà trả.",

    // Owner report
    report_label: "Bảng kê cho chủ nhà",
    report_title: "Chủ nhà phải biết nhà mình đang thế nào.",
    report_desc: "Đặt phòng, tiền thu, chi phí và những gì đã làm trong nhà. Mỗi tháng một trang.",
    report_text: "Không bảng biểu rối rắm. Nhà thu bao nhiêu, chi gì, chúng tôi làm gì, chủ nhà thấy hết.",
    ...
    report_cta: "Tôi muốn bảng kê như vậy",
    ...
    faq1_a: "Không sao. Chúng tôi xem nhà trước rồi nói rõ nên chuẩn bị gì.",
    faq3_q: "Muốn dùng nhà cho mình thì sao?",
    faq3_a: "Được. Báo trước là chúng tôi khóa lịch, cho gia đình hay người quen cũng vậy.",
    faq4_q: "Làm sao biết nhà thu được bao nhiêu?",
    faq4_a: "Mỗi tháng chủ nhà nhận một bảng kê gọn một trang: bao nhiêu đêm có khách, tiền từ Airbnb, từ Booking, phí 25%, và chúng tôi đã làm gì trong nhà. Kèm hóa đơn phí, số nào cũng có gốc.",
    faq5_q: "Phí bao nhiêu?",
    faq5_a: "25% tiền phòng, đã gồm VAT, không thu thêm gì. Không phí cố định, không phí tháng. Trong đó có cả internet, đồ dùng cho khách, hóa chất dọn dẹp. Sửa nhỏ đến 5 000 Kč chúng tôi làm luôn, trừ vào tiền phòng; việc lớn hơn thì báo chủ nhà trước, đồng ý mới làm.",
    faq6_q: "Ai trả tiền dọn dẹp, điện nước?",
    faq6_a: "Khách trả tiền phòng và trả thêm phí dọn dẹp. Phí dọn dẹp là của chúng tôi, để dọn và giặt, nên không trừ vào tiền phòng của chủ nhà; trong bảng kê là một dòng riêng. Chia 75/25 chỉ tính trên tiền phòng. Điện, nước, gas chủ nhà trả như trước.",
    faq7_q: "Hợp tác bao lâu, muốn nghỉ thì sao?",
    faq7_a: "Hợp đồng không thời hạn, muốn nghỉ báo trước 4 tháng. Khách hay đặt trước rất lâu, nên đặt phòng nào đã nhận thì vẫn làm cho hết.",
    faq9_q: "Con số trong máy tính là trước hay sau phí?",
    faq9_a: "Sau. Con số nào gọi là tiền về tay chủ nhà đều đã trừ 25%. Điện nước chủ nhà trả riêng.",
    faq10_q: "Cho thuê ngắn hạn phải lo giấy tờ gì?",
    faq10_a: "Đây là kinh doanh nên có quy định: sổ khách, khai báo khách nước ngoài với cảnh sát ngoại kiều, phí lưu trú nộp cho quận, và mới đây là đăng ký e-Turista. Giấy tờ về khách chúng tôi lo. Thuế thu nhập thì chủ nhà hoặc kế toán khai, chứng từ chúng tôi đưa đủ.",
    faq11_q: "Khách làm hỏng đồ thì sao?",
    faq11_a: "Khách đi là chúng tôi kiểm tra, nên không có chuyện tháng sau mới biết. Hỏng nhỏ sửa ngay (đến 5 000 Kč, trừ vào tiền phòng). Hỏng lớn thì chụp ảnh, lập biên bản, làm việc với khách và với Airbnb, Booking (Airbnb có bảo hiểm AirCover cho chủ nhà). Chủ nhà được báo ngay, có ảnh.",
    faq12_q: "Hàng xóm và ban quản trị nhà (SVJ)?",
    faq12_a: "Yên với hàng xóm thì mới cho thuê lâu dài được. Khách nhận nội quy trước khi đến, số người tối đa rõ ràng, không tiệc tùng, hàng xóm có số điện thoại để gọi. SVJ cấm rõ thì chúng tôi nói thẳng trước khi ký.",
    faq13_q: "Khi nào không nên cho thuê ngắn hạn?",
    faq13_a: "SVJ cấm hoặc hàng xóm không muốn. Chủ nhà cần tháng nào cũng đúng một số tiền, vì tiền theo mùa có lên có xuống. Chủ nhà muốn tự ở phần lớn thời gian. Nhà xuống cấp mà không muốn bỏ thêm gì. Còn lại chúng tôi đều xem được; xa trung tâm hay nhà cũ không phải vấn đề.",
    faq14_q: "Sao không tự làm qua Airbnb?",
    faq14_a: "Có người tự làm được. Nhưng đây là việc mỗi ngày: trả lời khách trong vài phút, chỉnh giá theo khách, lo dọn dẹp và chìa khóa, và nhất là theo kịp Airbnb, Booking đổi luật liên tục. Tuần làm một lần là nhà tụt hạng, bán rẻ. Chúng tôi làm hằng ngày cho nhiều nhà một lúc, khác nhau ở chỗ đó.",

    // Contact
    contact_label: "Liên hệ",
    contact_title: "Cùng bàn về căn nhà của quý vị.",
    contact_desc: "Gửi cho chúng tôi vài thông tin về nhà. Chúng tôi xem vị trí, tình trạng rồi nói chủ nhà nghe hướng nào hợp.",
    contact_name: "Họ tên",
    ...
    contact_small: "Chúng tôi gọi lại trong 24 giờ, tiếng Việt hay tiếng Séc tùy chủ nhà. Không ràng buộc gì.",
    contact_success: "Cảm ơn quý vị. Chúng tôi sẽ liên hệ trong 24 giờ.",
    ...
    // Contact (fallback)
    contact_fallback_title: "Cùng bàn về căn nhà của quý vị.",
    contact_fallback_desc: "Vài dòng về nhà là đủ, còn lại nói qua điện thoại.",
    ...
    footer_link_cookies: "Cookies",
    footer_cta: "Bàn về căn hộ",
    footer_rights: "© 2026 Donut Point, s.r.o. Mọi quyền được bảo lưu.",

    // Sticky mobile
    mobile_cta: "Bàn về căn hộ",

    // For you if…
    foryou_label: "Dành cho ai",
    foryou_title1: "Dành cho quý vị, ",
    foryou_title2: "nếu…",
    foryou_desc: "Những lý do chủ nhà hay tìm đến chúng tôi.",
    foryou1_title: "Từng bị người thuê quỵt tiền",
    foryou1_desc: "Nợ tiền nhà, phá nhà, đuổi không chịu đi. Khách ngắn hạn trả tiền trước, ở vài đêm rồi đi. Khỏi phải đòi, khỏi phải kiện.",
    foryou2_title: "Không có thời gian lo khách",
    foryou2_desc: "Khách hỏi han, nhận phòng, chìa khóa, nửa đêm có chuyện. Việc đó để chúng tôi lo.",
    foryou3_title: "Không muốn chạy theo Airbnb",
    foryou3_desc: "Airbnb, Booking tháng nào cũng đổi luật, đổi giá. Chúng tôi theo hằng ngày, chủ nhà khỏi phải bận tâm.",
    foryou4_title: "Sợ khách làm hỏng nhà",
    foryou4_desc: "Khách đi là chúng tôi vào dọn, kiểm tra, hỏng gì sửa ngay. Cho thuê dài hạn thì cả năm chủ nhà mới thấy nhà một lần.",
    foryou5_title: "Muốn giữ nhà cho gia đình",
    foryou5_desc: "Người nhà sang chơi, khách quý, hay về ở. Báo trước là chúng tôi khóa lịch.",
    foryou6_title: "Ở xa hoặc hay đi vắng",
    foryou6_desc: "Về Việt Nam nửa năm cũng không sao. Nhà vẫn có khách, tháng nào tiền về chủ nhà cũng thấy rõ.",
  },
} as const;
