const translations = {
  cs: {
    ...
    foryou1_antam: "Kontrola po každém pobytu, kvalitní úklid, detaily řešíme hned.",
    foryou1_long: "Stav bytu zjistíte často až po měsících nebo na konci smlouvy.",
    foryou1_desc: "",
    foryou2_title: "Potenciál výnosu",
    foryou2_antam: "Ceny podle sezóny, víkendů, svátků a akcí v Praze.",
    foryou2_long: "Stabilní nájem, ale bez reakce na špičky v poptávce.",
    foryou2_desc: "",
    foryou3_title: "Flexibilita pro majitele",
    foryou3_antam: "Termíny pro sebe, rodinu nebo návštěvy si plánujete dopředu.",
    foryou3_long: "Byt je vázaný jednou smlouvou na dlouhou dobu.",
    foryou3_desc: "",
    foryou4_title: "Přehled plateb",
    foryou4_antam: "Rezervace, výnosy a náklady přehledně v měsíčním reportu.",
    foryou4_long: "Platby, zpoždění a opravy řešíte sami s nájemníkem.",
    foryou4_desc: "",
  },
  ...
  vi: {
    ...
    foryou1_antam: "Kiểm tra sau mỗi lượt khách, vệ sinh kỹ, xử lý ngay.",
    foryou1_long: "Tình trạng căn hộ thường chỉ thấy sau vài tháng hoặc cuối hợp đồng.",
    foryou1_desc: "",
    foryou2_title: "Tiềm năng doanh thu",
    foryou2_antam: "Giá theo mùa, cuối tuần, ngày lễ và sự kiện ở Praha.",
    foryou2_long: "Tiền thuê ổn định nhưng không phản ứng với cao điểm.",
    foryou2_desc: "",
    foryou3_title: "Linh hoạt cho chủ nhà",
    foryou3_antam: "Giữ ngày cho mình, gia đình hay khách — lên lịch trước.",
    foryou3_long: "Căn hộ bị ràng buộc bởi một hợp đồng dài hạn.",
    foryou3_desc: "",
    foryou4_title: "Minh bạch thanh toán",
    foryou4_antam: "Đặt phòng, doanh thu và chi phí rõ ràng trong báo cáo tháng.",
    foryou4_long: "Thanh toán, chậm trễ, sửa chữa tự xử lý với người thuê.",
    foryou4_desc: "",
  },
} as const;
