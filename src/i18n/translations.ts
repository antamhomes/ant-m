const translations = {
  cs: {
    ...
    calc_season_summer: "Léto",
    calc_season_winter: "Zima",
    ...
    calc_excluded_note: "Provize platforem (cca 15,5 %) a energie nejsou v kalkulaci zahrnuty.",
  ...
  vi: {
    ...
    calc_excluded_note: "Phí nền tảng (khoảng 15,5 %) và tiền điện/nước không được tính trong dự toán.",
