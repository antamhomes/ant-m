const translations = {
  cs: {
    ...
    calc_split_note: "Částka nahoře je už váš podíl — po odečtení provize 25 %. V provizi je celá správa — hosté, ceny, komunikace, kontroly i zajištění oprav. Úklid a prádlo hradí host v ceně rezervace. Žádné další poplatky.",
    ...
    faq9_a: "Po. Vše, co na webu označujeme jako výnos pro majitele, je už po odečtení provize 25 %. Uvádíme částky bez DPH; energie hradí majitel zvlášť.",
    ...
    foryou3_title: "Chcete z bytu víc než tržní nájem",
    foryou3_desc: "Víte, že krátkodobý pronájem může vydělat víc — když ho někdo dělá pořádně a nemusíte se ho učit sami.",
  ...
  vi: {
    ...
    calc_split_fee: "Antam Homes",
    calc_split_note: "Số tiền ở trên đã là phần của quý vị — sau khi trừ phí dịch vụ 25%. Phí dịch vụ đã bao gồm toàn bộ việc quản lý — khách, giá, liên lạc, kiểm tra và lo việc sửa chữa. Phí dọn dẹp và giặt giũ do khách trả trong giá đặt phòng. Không có phí phát sinh.",
    ...
    faq9_a: "Sau. Mọi con số trên trang được gọi là thu nhập cho chủ nhà đều đã trừ phí dịch vụ 25%. Số tiền chưa gồm VAT; điện nước do chủ nhà trả riêng.",
    ...
    foryou3_title: "Muốn căn hộ mang lại nhiều hơn giá thuê dài hạn",
    foryou3_desc: "Quý vị biết cho thuê ngắn hạn có thể tốt hơn — nếu được làm bài bản và quý vị không phải tự học từ đầu.",
