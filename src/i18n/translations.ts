const translations = {
  cs: {
    ...
    g_num3_label: "",
    g_num3_value: "",
    g_num_note: "Ilustrační příklad: 2+kk v centru, částky za měsíc (nájem 26\u00a0000 Kč + energie 3\u00a0500 Kč). Minimum sjednáváme jako roční částku pro konkrétní byt.",
    ...
    calc_title2: "váš byt?",
    calc_desc: "Lokalita, dispozice, plocha. Tři údaje, výsledek z\u00a0realizovaných cen celé čtvrti, ne\u00a0z\u00a0ceníků.",
    calc_location: "Lokalita",
    calc_loc_other: "Jinde / mimo Prahu",
    calc_size: "Dispozice",
    calc_size_hint: "O\u00a0výdělku rozhoduje, kolik hostů se vejde. Odvodíme to z\u00a0dispozice a\u00a0plochy tak, jak byty listujeme: ložnice a\u00a0rozkládací gauč v\u00a0obýváku. Přesně to určíme při\u00a0prohlídce.",
    calc_area: "Plocha bytu",
    calc_area_hint: "Řídí dlouhodobý nájem, se kterým výnos porovnáváme. Větší byt pojme víc\u00a0hostů.",
    calc_range_to: "až",
    ...
    calc_disclaimer: "Orientační kalkulace, nikoli nabídka. Cena za\u00a0noc i\u00a0obsazenost jsou tržní průměr celé čtvrti pro danou velikost bytu (PriceLabs STR index, oficiální hranice čtvrti, 12 uzavřených měsíců do\u00a07/2026); kde je\u00a0vzorek nabídek malý, číslo neukazujeme. Ukazujeme dvě čísla ze stejných dat: průměr trhu (tržní obsazenost čtvrti) a\u00a0odhad s\u00a0námi, kde stejnou cenu za\u00a0noc počítáme s\u00a0obsazeností trhu zvednutou o\u00a015\u00a0%, nejvýš 85\u00a0%. Byty v\u00a0naší správě dosahují 85 až\u00a097\u00a0%, tedy víc, než s\u00a0čím počítáme. Pásmo trhu určuje počet ložnic (1+kk a\u00a02+kk jedna, 3+kk dvě, 4+kk tři a\u00a0víc), ne\u00a0počet hostů. Provize platforem se\u00a0v\u00a0modelu počítá 17 %, ve\u00a0skutečnosti se\u00a0pohybuje mezi 15 a\u00a021 %. Dlouhodobý nájem počítáme z\u00a0Deloitte Rent Index Q2/2026 podle skutečné plochy bytu; že menší byt má vyšší nájem za\u00a0m², bereme z\u00a0cenové mapy Ministerstva financí (15. 8. 2026). Skutečný výnos kolísá podle stavu bytu, sezóny, recenzí i\u00a0regulace. Garance výnosu vzniká až\u00a0písemným ujednáním pro konkrétní byt.",
  ...
  vi: {
    ...
    g_num3_label: "",
    g_num3_value: "",
    g_num_note: "Ví dụ minh họa: căn 2+kk ở trung tâm, số tiền mỗi tháng (tiền thuê 26\u00a0000 Kč + điện nước 3\u00a0500 Kč). Mức tối thiểu được tính theo năm, riêng cho từng căn.",
    ...
    calc_desc: "Quận, loại nhà, diện tích. Ba thứ thôi, con số tính từ giá thật cả quận, không phải giá niêm yết.",
    calc_location: "Quận",
    calc_loc_other: "Nơi khác / ngoài Praha",
    calc_size: "Loại nhà",
    calc_size_hint: "Thu nhập tùy vào nhà ở được mấy khách. Antam suy ra từ loại nhà và diện tích, đúng như cách Antam đăng nhà: phòng ngủ cộng sofa giường ở phòng khách. Đến xem nhà sẽ tính\u00a0chính\u00a0xác.",
    calc_area: "Diện tích",
    calc_area_hint: "Quyết định tiền thuê dài hạn, phần mình đem ra so sánh. Nhà rộng hơn ở được nhiều\u00a0khách\u00a0hơn.",
    calc_range_to: "đến",
