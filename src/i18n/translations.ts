const translations = {
  cs: {
    ...
    calc_basis: "Tržní data celé čtvrti podle velikosti bytu: realizované ceny a\u00a0průměrná obsazenost okolí (PriceLabs, 12 měsíců). Byty v\u00a0naší správě drží obsazenost nad průměrem okolí. Odhad, ne\u00a0nabídka ani garance.",
  ...
  vi: {
    ...
    calc_basis: "Tính từ số liệu thị trường của cả quận theo cỡ căn nhà: giá thật đã bán và tỷ lệ kín phòng trung bình quanh đó (PriceLabs, 12 tháng). Các căn Antam lo đều kín phòng cao hơn mức trung bình của quận. Là ước tính, không phải báo giá hay cam kết.",
