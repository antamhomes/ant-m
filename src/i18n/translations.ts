const translations = {
  cs: {
    ...
    calc_area_hint: "Plocha řídí dlouhodobý nájem. Když vyjede z\u00a0pásma zvolené dispozice, dispozici přepneme a\u00a0s\u00a0ní i\u00a0cenu za\u00a0noc.",
    calc_season: "Sezóna",
  ...
  vi: {
    ...
    calc_area: "Diện tích",
    calc_area_hint: "Diện tích quyết định tiền thuê dài hạn. Kéo ra ngoài khoảng của loại nhà đang chọn thì Antam đổi loại nhà, giá mỗi đêm đổi\u00a0theo.",
    calc_season: "Mùa",
