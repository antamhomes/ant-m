const translations = {
  cs: {
    ...
    calc_title2: "váš byt?",
    calc_desc: "Lokalita a\u00a0dispozice. Dva údaje, výsledek z\u00a0realizovaných cen celé čtvrti, ne\u00a0z\u00a0ceníků.",
    calc_location: "Lokalita",
    calc_loc_other: "Jinde / mimo Prahu",
    calc_size: "Dispozice",
    calc_size_hint: "Cenu za\u00a0noc určuje lokalita a\u00a0počet ložnic, tak to na\u00a0Airbnb funguje: 1+kk a\u00a02+kk bereme jako jednu ložnici, 3+kk dvě, 4+kk tři a\u00a0víc.",
    calc_area_range_1: "Počítáme s\u00a0bytem",
    calc_area_range_2: "až",
    calc_area_range_3: "nájem pro",
    calc_area_range_4: "Přesnou plochu dosadíme v\u00a0propočtu do\u00a024\u00a0hodin.",
    calc_ltr_for: "pro",
    ...
    calc_basis: "Reálná tržní cena za\u00a0noc v\u00a0celé čtvrti (PriceLabs, 12 měsíců) a\u00a0obsazenost, se kterou počítáme my: trh zvednutý o\u00a015\u00a0%, nejvýš 85\u00a0%. Byty v\u00a0naší správě měří 85 až\u00a097\u00a0%. Odhad, ne\u00a0nabídka ani garance.",
    ...
    calc_5y_market: "Měsíčně při průměru trhu",
  ...
  vi: {
    ...
    calc_desc: "Quận và loại nhà. Hai thứ thôi, con số tính từ giá thật cả quận, không phải giá niêm yết.",
    calc_location: "Quận",
    calc_loc_other: "Nơi khác / ngoài Praha",
    calc_size: "Loại nhà",
    calc_size_hint: "Giá mỗi đêm do khu và số phòng ngủ quyết định, Airbnb là vậy: 1+kk và 2+kk tính là một phòng ngủ, 3+kk hai, 4+kk ba trở\u00a0lên.",
    calc_area_range_1: "Antam tính cho căn",
    calc_area_range_2: "đến",
    calc_area_range_3: "tiền thuê dài hạn tính cho",
    calc_area_range_4: "Diện tích đúng của căn nhà mình, Antam tính trong bản tính 24\u00a0giờ.",
    calc_ltr_for: "cho",
    ...
    calc_basis: "Giá thật mỗi đêm của cả quận (PriceLabs, 12 tháng) và tỷ lệ kín phòng Antam tính: mức thị trường cộng thêm 15%, tối đa 85%. Các căn Antam lo đang đạt 85 đến 97%. Là ước tính, không phải báo giá hay cam kết.",
    ...
    calc_5y_market: "Mỗi tháng theo trung bình thị trường",
    ...
    hz_legend_market: "Trung bình thị trường",
