const translations = {
  cs: {
    ...
    faq7_a: "Smlouvu uzavíráme na jeden rok. Poté pokračuje dál a kdykoli ji lze ukončit s výpovědní lhůtou 6 měsíců. Hosté si často rezervují s velkým předstihem, proto se během výpovědní lhůty potvrzené rezervace ještě dokončí.",
  ...
  vi: {
    ...
    comp1_long: "Cả năm mới thấy nhà mình một lần, có khi còn không.",
    ...
    comp3_long: "Ký hợp đồng dài hạn rồi, muốn lấy lại nhà cũng không dễ.",
    ...
    faq6_a: "Khách trả tiền phòng và trả thêm phí dọn dẹp. Phí dọn dẹp thuộc về Antam, dùng để dọn và giặt, nên không trừ vào tiền phòng của chủ nhà; trong bảng kê nó là một dòng riêng. Phần chia 75/25 chỉ tính trên tiền phòng. Điện, nước, gas chủ nhà lo.",
    faq7_q: "Hợp tác bao lâu, muốn nghỉ thì sao?",
    faq7_a: "Hợp đồng ký một năm. Sau đó, nếu muốn dừng hợp tác thì chỉ cần báo trước 6 tháng. Những đặt phòng đã xác nhận thì Antam vẫn lo cho hết.",
    ...
    faq11_a: "Khách đi là Antam kiểm tra ngay, không có chuyện tháng sau mới biết. Hỏng nhỏ được sửa ngay (đến 5 000 Kč, trừ vào tiền phòng). Hỏng lớn thì chụp ảnh, lập biên bản, làm việc với khách và với Airbnb, Booking. Airbnb có bảo hiểm AirCover cho chủ nhà. Anh chị được báo ngay, có ảnh kèm theo.",
    ...
    foryou3_desc: "Airbnb, Booking tháng nào cũng đổi luật, đổi giá. Chậm theo là nhà mình bị tụt hạng, phải bán rẻ. Antam theo sát mỗi ngày cho chủ nhà.",
