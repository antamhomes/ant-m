const translations = {
  ...
  vi: {
    ...
    services_desc: "Nội thất khách thích. Ảnh đẹp thì khách mới chọn. Giá đúng theo mùa. Phục vụ tốt thì mới được đánh giá cao. Việc nào Antam cũng làm như nghề của mình, và làm cùng lúc.",
    svc1_title: "Chuẩn bị nhà và nội thất",
    svc1_desc: "Antam tư vấn cách sắp xếp, trang bị và những chi tiết nhỏ quyết định đánh giá. Không bảo mua thừa.",
    ...
    svc6_desc: "Khách đặt bao nhiêu, thu bao nhiêu, chi gì, làm gì trong nhà. Gọn trong một trang.",
    ...
    whyBetter_desc: "Cho thuê dài hạn thì đơn giản. Còn cho thuê ngắn hạn, nếu có người làm bài bản, vừa nắm nhà chắc hơn, vừa thu về nhiều hơn.",
    ...
    comp3_short: "Muốn về ở, chỉ cần báo trước.",
    ...
    step4_desc: "Khách, dọn dẹp, giá, lịch: Antam lo hết.",
    ...
    about_p2: "Nói chuyện với Antam bằng tiếng Việt hay tiếng Séc đều được, qua điện thoại, Zalo hay WhatsApp. Nhà nào Antam cũng biết tận nơi, khách tự tay lo, tháng nào cũng có bảng kê rõ từng đồng.",
    ...
    calc_desc: "Antam ước tính theo loại nhà, quận và lượng khách. Con số để tham khảo.",
    calc_location: "Quận",
    calc_size: "Loại nhà",
    ...
    report_text: "Không bảng biểu rối rắm. Nhà thu bao nhiêu, chi gì, Antam đã làm gì, chủ nhà thấy hết.",
    ...
    faq1_a: "Không sao. Antam xem nhà trước rồi nói rõ nên chuẩn bị gì.",
    ...
    faq4_a: "Mỗi tháng Antam gửi một bảng kê gọn một trang: bao nhiêu đêm có khách, tiền từ Airbnb, từ Booking, phí 25%, và Antam đã làm gì trong nhà. Kèm hóa đơn phí, nên số nào cũng có gốc.",
    ...
    faq6_a: "Khách trả tiền phòng và trả thêm phí dọn dẹp. Phí dọn dẹp thuộc về Antam, dùng để dọn và giặt, nên không trừ vào tiền phòng của chủ nhà; trong bảng kê nó là một dòng riêng. Phần chia 75/25 chỉ tính trên tiền phòng. Điện, nước, gas chủ nhà lo như trước.",
    ...
    faq10_a: "Cho thuê ngắn hạn là kinh doanh nên có quy định: sổ khách, khai báo khách nước ngoài với cảnh sát ngoại kiều, phí lưu trú nộp cho quận, và mới đây là đăng ký e-Turista. Giấy tờ về khách Antam lo. Thuế thu nhập thì chủ nhà hoặc kế toán khai, chứng từ Antam đưa đủ.",
    ...
    contact_desc: "Gửi cho Antam vài thông tin về nhà. Antam xem vị trí, tình trạng rồi nói hướng nào hợp.",
    contact_name: "Họ tên",
    ...
    foryou2_desc: "Khách hỏi han, nhận phòng, chìa khóa, nửa đêm có chuyện. Những việc đó cứ để Antam lo.",
    foryou3_title: "Không muốn chạy theo Airbnb",
    foryou3_desc: "Airbnb, Booking tháng nào cũng đổi luật, đổi giá. Antam theo sát mỗi ngày, chủ nhà không phải bận tâm.",
    foryou4_title: "Sợ khách làm hỏng nhà",
    foryou4_desc: "Khách đi là Antam vào dọn và kiểm tra ngay, có gì hỏng thì sửa luôn. Cho thuê dài hạn thì cả năm mới thấy nhà một lần.",
    foryou5_title: "Muốn giữ nhà cho gia đình",
    foryou5_desc: "Người nhà sang chơi, có khách quý, hay muốn về ở vài hôm. Chỉ cần báo trước, Antam khóa lịch ngay.",
