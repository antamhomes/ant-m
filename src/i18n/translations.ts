const translations = {
  cs: {
    ...
    about_title: "Spravujeme jedenáct bytů. Začali jsme na vlastních.",
    about_p1: "Spravujeme byty od garsonky 22 m² po loft 110 m², v Praze a v Mladé Boleslavi. Obsazenost mají vyšší než průměr okolí; čísla za každý byt jsou výš v Portfoliu.",
    about_p2: "Vystavit byt na Airbnb umí každý. Rozdíl dělá cena, kterou měníme každý den, fotky, rychlost odpovědí a hodnocení. To hlídáme u každého bytu zvlášť.",
    ...
    calc_title2: "váš byt?",
    calc_desc: "Lokalita, dispozice, kapacita. Výsledek počítáme z realizovaných cen okolních bytů, ne z ceníků.",
    calc_location: "Lokalita",
    calc_loc_other: "Jinde / mimo Prahu",
    calc_size: "Dispozice",
    calc_size_hint: "Dispozice jen předvyplní kapacitu a plochu. Výnos počítáme z kapacity, nájem z plochy, energie a obnovu vybavení podle dispozice.",
    ...
    pr1_note: "Čísla ve schématu jsou vzor pro 50 000 Kč na účtu, ne konkrétní byt. 30 % je konečná odměna Antam Homes. Úklidový poplatek platí hosté zvlášť a kryje úklid a prádlo; energie hradí majitel.",
    ...
    pr2_note: "Nákupní seznam vybavení, nastavení bytu, profesionální focení, texty, nastavení cen a spuštění prodeje. Platí se jednou.",
    ...
    pr8_note: "Přivedete majitele, jehož byt vezmeme do správy, a dostanete zpět 15 000 Kč z uvedení do provozu. Za každého dalšího vám z naší odměny slevíme 1 % z výnosu.",
  ...
  vi: {
    ...
    hero_desc: "Quản lý cho thuê ngắn hạn tại Praha. Căn nào Antam nhận cũng có mức thu tối thiểu mỗi năm, ghi rõ trong hợp đồng. Khách làm hỏng lặt vặt, Antam lo.",
    ...
    about_title: "Antam làm việc này mỗi ngày, với 11 căn.",
    about_p1: "Antam đang lo từ căn nhỏ 22 m² đến căn 110 m², ở Praha và Mladá Boleslav. Tỷ lệ kín phòng của các căn này cao hơn khu xung quanh, số cụ thể ở mục Kết quả.",
    ...
    calc_desc: "Antam ước tính theo quận, loại nhà và mùa. Con số này tính thấp hơn kết quả thật của các căn Antam đang lo.",
    calc_location: "Quận",
    calc_loc_other: "Nơi khác / ngoài Praha",
    calc_size: "Loại nhà",
    calc_size_hint: "Chọn loại nhà thì Antam điền sẵn số khách và diện tích. Thu nhập tính theo số khách. Tiền thuê dài hạn tính theo diện tích. Điện nước và thay đồ tính theo loại nhà.",
    ...
    pr1_note: "Số trong sơ đồ là ví dụ cho 50 000 Kč về tài khoản, không phải một căn cụ thể. 30 % là phí cuối cùng của Antam Homes, không cộng thêm gì, không phí cố định, không phí tháng. Phí dọn dẹp khách trả riêng và dùng để dọn và giặt; điện nước chủ nhà lo.",
    ...
    pr8_price: "Hoàn lại 15 000 Kč",
    pr8_note: "Anh chị giới thiệu một chủ nhà và Antam nhận căn đó, thì Antam hoàn lại 15 000 Kč phí đưa nhà vào vận hành. Mỗi chủ nhà tiếp theo, Antam giảm phí cho anh chị 1 % doanh thu.",
