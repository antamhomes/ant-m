const translations = {
  cs: {
    ...
    hero_desc: "Kompletní správa krátkodobého pronájmu — od přípravy nabídky po hosty, úklid a přehledné výnosy.",
    ...
    svc1_title: "Příprava nabídky",
    svc1_desc: "Fotky, popis, pravidla a nastavení bytu na platformách.",
    svc2_title: "Hosté a komunikace",
    svc2_desc: "Dotazy, informace k příjezdu, průběžná podpora a řešení situací.",
    svc3_title: "Úklid a kontrola",
    svc3_desc: "Po každém pobytu byt kontrolujeme a hlídáme detaily, aby zůstal v dobrém stavu a dlouhodobě dobře pronajímatelný.",
    svc4_title: "Cena a obsazenost",
    svc4_desc: "Pracujeme s cenou, sezónou a kalendářem, aby byt nezůstával zbytečně prázdný.",
    svc5_title: "Přehled pro majitele",
    svc5_desc: "Jasný přehled rezervací, výnosů, nákladů a důležitých informací o bytu.",
    ...
    detail1_desc: "Čistý, připravený prostor působí důvěryhodně hned od první fotky.",
    detail2_title: "Čistý první dojem",
    detail2_desc: "Detaily, světlo a pořádek pomáhají bytu působit lépe už při prohlížení nabídky.",
    detail3_title: "Prostor, který působí důvěryhodně",
    detail3_desc: "Hosté si rychleji vyberou byt, který na první pohled působí udržovaně a jasně.",
    ...
    calc_excluded_note: "Naše provize a energie nejsou v kalkulaci zahrnuty.",
  ...
  vi: {
    ...
    calc_cleaning: "Dọn dẹp (10×/tháng)",
    calc_operations: "Internet + đồ tiêu hao",
    calc_our_fee: "Phí dịch vụ của chúng tôi",
    calc_cleaning_note: "",
    calc_net: "Lợi nhuận ròng vào túi chủ",
    calc_net_year: "mỗi năm",
    ...
    calc_excluded_note: "Phí dịch vụ của chúng tôi và tiền điện/nước không được tính trong dự toán.",
