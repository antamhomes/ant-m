const translations = {
  ...
  vi: {
    ...
    svc6_desc: "Khách đặt bao nhiêu, thu bao nhiêu, chi gì, làm gì trong nhà. Rõ ràng, gọn trong một trang.",
    ...
    about_p1: "Antam Homes do người Việt và người Séc ở Praha lập nên. Cho thuê ngắn hạn, Antam học từ chính những căn nhà đang lo, chứ không phải từ sách vở. Bắt đầu với nhà của gia đình và người quen, đến nay Antam lo khoảng mười căn ở Praha và quanh Praha.",
    ...
    faq7_a: "Hợp đồng không thời hạn, muốn nghỉ báo trước 4 tháng. Khách hay đặt trước nhiều tháng, nên đặt phòng nào đã nhận thì Antam vẫn làm cho hết.",
