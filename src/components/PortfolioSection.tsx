...
const copy = {
  cs: {
    eyebrow: "Výsledky",
    title: "Co naše byty vydělávají majitelům",
    desc: "Skutečné výsledky z měsíčních vyúčtování.",
    guests: (n: number) => `až ${n} host${n === 4 ? "é" : "ů"}`,
    soonTitle: "Nově v naší správě",
    soonDesc: "Výsledky doplníme po první sezóně.",
    soonDescShort: "Výsledky doplníme po první sezóně.",
