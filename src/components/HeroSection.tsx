    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-primary-foreground text-center px-6 max-w-4xl mx-auto">
        <motion.h1
          ...
          className="font-display text-7xl sm:text-6xl md:text-7xl lg:text-[5.5rem] font-bold text-primary-foreground leading-[1.05] tracking-[-0.025em] mb-6 [text-shadow:0_2px_24px_hsl(var(--charcoal)/0.55)]"
        >
          {t(lang, "hero_title1")}
          <br />
