      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <a
              href="#kontakt"
              className="inline-flex items-center gap-2 px-7 py-3.5 bg-gold text-accent-foreground font-body font-semibold text-sm tracking-wider uppercase rounded-sm hover:brightness-110 transition-all"
            >
              {t(lang, "report_cta")}
