 ...
 */
export const fiveYear = (location: CalcLoc, guests: number, size: SizeKey, m2: number, furn: Furn) => {
  ...
  return { lt, str, rent, y2, setup, kit, projectFee, energy, renew, payback, cross, gap: str[HORIZON_MONTHS] - lt[HORIZON_MONTHS] };
};
