...
// (already net of its own commission), minus the cleaning fee, then the 72/28 split. Airbnb
...
const apartments = [
  ...
  { name: "Elegant Museum View Apartment (402)", location: "Praha 1", maxGuests: 8, ownerMonthlyCzk: 65000, occupancyPct: 96, period: "12 months to 2026-07", vsLongTermRent: 2.5 },
  { name: "Modern Museum View Apartment (405)", location: "Praha 1", maxGuests: 8, ownerMonthlyCzk: 59000, occupancyPct: 94, period: "12 months to 2026-07", vsLongTermRent: 2.3 },
  { name: "Modern AC Apartment", location: "Praha 3", maxGuests: 6, ownerMonthlyCzk: 51000, occupancyPct: 96, period: "2026-02 to 2026-07", vsLongTermRent: 1.9 },
  { name: "Moderní apartmán se zahradou", location: "Praha 3", maxGuests: 6, ownerMonthlyCzk: 43000, occupancyPct: 85, period: "2026-04 to 2026-07", vsLongTermRent: 1.5 },
  ...
  { name: "Klement apartment s terasou", location: "Mladá Boleslav", maxGuests: 8, ownerMonthlyCzk: 31000, occupancyPct: 91, period: "2026-04 to 2026-07" },
  { name: "Klement apartment", location: "Mladá Boleslav", maxGuests: 8, managedSince: "2026-08", note: "new, results after the first season" },
  { name: "My Mozart studio", location: "Praha 5", maxGuests: 4, ownerMonthlyCzk: 30000, occupancyPct: 97, period: "2026-02 to 2026-07", vsLongTermRent: 1.4 },
];
