...
const faq = [
  ...
  { question: "Jak dlouho spolupráce trvá a jak ji ukončím?", answer: "Smlouva se uzavírá na jeden rok, poté pokračuje a lze ji ukončit s výpovědní lhůtou 6 měsíců. Potvrzené rezervace se během výpovědní lhůty ještě dokončí." },
