...
const faq = [
  ...
  { question: "Jak budu vědět, co byt vydělává?", answer: "Každý měsíc zpětně přehled na jednu stranu: obsazené noci, výnos z jednotlivých platforem, DPH z provize platformy, odměna 25 % a co se v bytě řešilo, spolu s fakturou na odměnu. Vyúčtování i výplata proběhnou do 15. dne následujícího měsíce." },
  { question: "Kolik správa stojí?", answer: "Naše odměna je 25 % z čistého výnosu: tržby za ubytování bez úklidového poplatku, po odečtení provize Airbnb/Booking.com a zákonné DPH z této provize. Je konečná, nic dalšího se nepřičítá, bez fixních ani měsíčních poplatků. Pokrývá i internet, hygienické potřeby pro hosty a čisticí prostředky. Drobné opravy do 5 000 Kč vyřídíme sami a náklady strhneme z výnosu, dohromady nejvýše 20 000 Kč za rok; větší opravy nejdřív nahlásíme majiteli." },
  ...
  { question: "Je částka v kalkulačce před, nebo po provizi?", answer: "Po. Vše označené jako výnos pro majitele je už po odečtení provize platformy včetně DPH z ní i odměny 25 %. Odměna je konečná; energie hradí majitel zvlášť." },
