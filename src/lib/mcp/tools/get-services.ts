...
const faq = [
  ...
  { question: "Jak budu vědět, co byt vydělává?", answer: "Každý měsíc zpětně přehled na jednu stranu: obsazené noci, výnos z jednotlivých platforem, DPH z provize platformy, odměna 30 % a co se v bytě řešilo, spolu s fakturou na odměnu. Vyúčtování i výplata proběhnou do 15. dne následujícího měsíce." },
