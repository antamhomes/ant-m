...
const faq = [
  ...
  { question: "Můžu byt někdy využít pro sebe?", answer: "Byt si můžete kdykoli blokovat pro sebe nebo rodinu. U nejvytíženějších svátků, jako jsou Vánoce, Silvestr a Velikonoce, se na termínu nejdřív domluvíme. Už potvrzené rezervace hostů zůstávají nedotčené. Prvních 14 nocí v roce je bez odměny Antam Homes, majitel platí jen úklid; garantovaná roční částka se za blokované noci poměrně snižuje, včetně těchto 14." },
  { question: "Jak budu vědět, co byt vydělává?", answer: "Každý měsíc zpětně přehled na jednu stranu: obsazené noci, výnos z jednotlivých platforem, provize platforem, odměna 30 % a co se v bytě řešilo, spolu s fakturou na odměnu. Vyúčtování i výplata proběhnou do 15. dne následujícího měsíce." },
