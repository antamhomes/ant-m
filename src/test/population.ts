...
/**
 * JEDINÝ zdroj veřejné vstupní množiny pro testy. Odsud čerpá regresní
 * baseline (calc-population.test.ts) i invariant monotonie podle velikosti
 * (size-monotonicity.test.ts). Kdo opraví enumeraci tady, opraví ji všude —
 * přesně proto to není zkopírované do každého testu zvlášť.
 */
/** Lokality nabízené kalkulačkou: 10 pražských obvodů + „jinde". */
export const LOCS = ["praha1","praha2","praha3","praha4","praha5",
              "praha6","praha7","praha8","praha9","praha10","jinde"] as const;
export const SIZES: SizeKey[] = ["1kk","2kk","3kk","4kk"];
export const SEASONS: SeasonKey[] = ["year","summer","winter","xmas"];
